...
const indexData = [
  ...
  },
  {
    ...
    entries: [
      ...
      { title: "Data Science & ML", keywords: ["pandas", "numpy", "scikit-learn", "xgboost", "matplotlib", "seaborn", "plotly", "shap", "eda", "machine learning"], text: "Pandas, NumPy, Scikit-learn, XGBoost, Matplotlib, Seaborn, Plotly, SHAP, EDA" },
      { title: "Databases", keywords: ["postgresql", "mysql", "sqlite", "redis", "alembic", "database"], text: "PostgreSQL, MySQL, SQLite, Redis, Alembic" },
  ...
  },
  {
    ...
    entries: [
      ...
      { title: "02 — Database Insight Assistant", keywords: ["database", "analytics", "django", "drf", "langchain", "qdrant", "chart.js", "d3.js", "sql agent", "dashboard", "power bi"], text: "AI-powered database analytics — 60+ endpoints, 30K+ LOC, 4-agent orchestration, glassmorphism frontend with D3.js force-directed graphs." },
      ...
      { title: "05 — Database Communicator RAG", keywords: ["rag", "nl-to-sql", "gemini", "chromadb", "semantic", "caching", "mysql", "pandas", "csv"], text: "RAG-based NL-to-SQL system with semantic similarity caching via ChromaDB (~5ms hits), auto CSV export for large datasets." },
      ...
      { title: "08 — ML Prediction & Analytics", keywords: ["machine learning", "scikit-learn", "xgboost", "shap", "churn", "prediction", "eda", "fastapi"], text: "End-to-end ML workflows: EDA, feature engineering, hyperparameter tuning, SHAP interpretability for churn prediction." },
      ...
      { title: "10 — Secure Microservice API", keywords: ["fastapi", "celery", "redis", "jwt", "oauth2", "pytest", "alembic", "gitlab ci", "85%", "coverage"], text: "Production FastAPI microservice with OAuth2+JWT, refresh token rotation, 85%+ test coverage, dual-database support." },
